...
function AdminFavorsPageContent() {
    const { favors: allFavors, drivers, saveFavor, deleteFavor, appSettings } = useAppData();
    ...
    // Filtrar favors que tienen quote valido
    const favors = allFavors.filter(f => f.quote && f.quote.totalFee !== undefined);

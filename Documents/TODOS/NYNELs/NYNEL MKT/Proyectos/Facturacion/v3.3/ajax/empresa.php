         ...
         while ($reg=$rspta->fetch_object()){
             ...
             $data[]=array(
                 ...
                 "4"=>$reg->web,
                  ...
                  "5"=>($reg->logo=="")?"<img src='../files/logo/simagen.png' height='50px' width='50px'>":

                 "<img src='../files/logo/".$reg->logo."' height='50px' width='50px'>",
                 
                 //"6"=>'<button class="btn btn-icon btn-wave waves-effect waves-light btn-sm btn-success-light" onclick="mostrar('.$reg->idempresa.')"><i class="fa fa-pencil"></i></button>'
                 "6" => '<button class="btn btn-icon btn-sm btn-info" onclick="mostrar('.$reg->idempresa.')"><i class="ri-edit-line"></i></button>'

...
(
  ...
  left join 
      detalle_fac_art dfa on f.idfactura = dfa.idfactura
  where 
      YEAR(f.fecha_emision_01) = '$fecha_desde' 
      and MONTH(f.fecha_emision_01) = '$fecha_hasta'
      and p.tipo_persona = 'cliente' 
      and f.estado in ('5', '3', '0', '6', '1', '4')  
      and e.idempresa = '$idempresa' 
      and f.tipo_moneda_28 = '$tmon'
...
left join 
  detalle_boleta_producto dbp on b.idboleta = dbp.idboleta
where 
    YEAR(b.fecha_emision_01) = '$fecha_desde' 
    and MONTH(b.fecha_emision_01) = '$fecha_hasta'
  and p.tipo_persona = 'cliente' 
  and b.estado in ('5', '3', '0', '6', '1', '4')  
  and e.idempresa = '$idempresa' 
  and b.tipo_moneda_24 = '$tmon'
...
left join 
  detalle_notapedido_producto dnpp on np.idboleta = dnpp.idboleta
where 
    YEAR(np.fecha_emision_01) = '$fecha_desde' 
    and MONTH(np.fecha_emision_01) = '$fecha_hasta'
  and p.tipo_persona = 'cliente' 
  and np.estado in ('5', '3', '0', '6', '1', '4')  
  and e.idempresa = '$idempresa' 
  and np.tipo_moneda_24 = '$tmon'
...
inner join 
  empresa e on ncd.idempresa = e.idempresa 
where 
    YEAR(ncd.fecha) = '$fecha_desde' 
     and MONTH(ncd.fecha) = '$fecha_hasta'
  and p.tipo_persona = 'cliente' 
  and ncd.estado in ('5', '3', '0', '1', '4')  
  and e.idempresa = '$idempresa' 
  and ncd.tipo_moneda = '$tmon'
...
boletaservicio b inner join persona p on b.idcliente=p.idpersona inner join usuario u on 
  ...
  public function insertarnotificacion($codigonotificacion, $nombrenotificacion, $fechacreacion, $fechaaviso, $continuo, $tipocomprobante, $idcliente, $estadonoti)
  {
    ...
    $sql = "INSERT INTO notificaciones (codigonotificacion, nombrenotificacion, fechacreacion, fechaaviso, continuo, tipocomprobante, idpersona, estado)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    return ejecutarConsultaPreparada($sql, "ssssssss", [
      $codigonotificacion, $nombrenotificacion, $fechacreacion, $fechaaviso,
...
where year(fecha_baja)='$ano' and month(fecha_baja)='$mes' and day(fecha_baja)='$dia' and b.estado='3'
  ...
  public function avanzar($idnotificacion)
  {
    ...
    return ejecutarConsultaPreparada($sql, "i", [$idnotificacion]);
  }

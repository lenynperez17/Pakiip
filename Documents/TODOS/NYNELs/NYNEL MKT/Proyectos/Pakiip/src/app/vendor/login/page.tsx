...
export default function VendorLoginPage() {
  ...
  // Redirigir si ya está autenticado como vendor
  useEffect(() => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (result.success && result.user) {
        ...
        // El useEffect (líneas 36-40) se encargará de redirigir al dashboard correcto
        // solo si el usuario tiene role === 'vendor'
      } else {
        toast({
